...
var paginarEnt = function (entitie, page) {
    var itemsPorPag = 10;
    var idxInicial = (page - 1) * itemsPorPag;
    var idxFinal = idxInicial + itemsPorPag;
    var itemsPaginados = entitie.slice(idxInicial, idxFinal);
    var pagTotales = Math.ceil(entitie.length / itemsPorPag);
    return {
        page: page,
...
console.log(paginarEnt(users, 1));
